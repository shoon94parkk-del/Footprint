...
const {scan}=require('./server2');

const child=spawn(process.execPath,['server2.js'],{stdio:'inherit'});
...
setTimeout(async()=>{
  ...
  try{
    ...
    const patents=(r.report.grouped.patent||[]).slice(0,12);
    ...
    console.error('[SELFTEST] semes-park failed',e&&e.stack||e);
  }
},1200);
